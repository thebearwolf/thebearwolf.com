...
import { Geist, Geist_Mono, Syne, Cormorant_Garamond } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${syne.variable} ${cormorant.variable} font-sans antialiased`}
      >
        <Header />
        {children}
        <Footer />
